...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler,
    ...
    // @Override
    // public void onAttachedToEngine(@NonNull final FlutterPluginBinding
    ...
    // @Override
    // public void onAttachedToActivity(@NonNull ActivityPluginBinding
    // activityPluginBinding) {
    // Log.d(LIBRARY_NAME, String.format("FFmpegKitFlutterPlugin %s attached to
    // activity %s.", this, activityPluginBinding.getActivity()));
    ...
    // final Activity activity, final
    // io.flutter.plugin.common.PluginRegistry.Registrar registrar, final
    ...
    // methodChannel.setMethodCallHandler(this);
    // } else {
    // Log.i(LIBRARY_NAME, "FFmpegKitFlutterPlugin method channel was already
    // initialised.");
    // }
    ...
    // } else {
    // Log.i(LIBRARY_NAME, "FFmpegKitFlutterPlugin event channel was already
    // initialised.");
    // }
    ...
    // Log.d(LIBRARY_NAME, String.format("FFmpegKitFlutterPlugin %s initialised with
    // context %s and activity %s.", this, context, activity));
    // }
    protected void init(final BinaryMessenger messenger, final Context context, final Activity activity,
        ...
        Log.d(LIBRARY_NAME, String.format("FFmpegKitFlutterPlugin %s initialized with context %s and activity %s.",
